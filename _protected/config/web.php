...
$config = [
    'id' => 'ditta',
    'name' => $params['anoAppName'] ? $params['anoAppName'] : 'logbook',
    'language' => 'id',
    ...
    'modules' => [
        ...
        'klasifikasi' => [
            'class' => 'app\modules\klasifikasi\Module',
        ],
        'transaksi' => [
            'class' => 'app\modules\transaksi\Module',
        ],       
        'usage' => [
            'class' => 'app\modules\usage\Module',
        ],
        'perencanaan' => [
            'class' => 'app\modules\perencanaan\Module',
        ],
    ],     
    'components' => [
        'request' => [
